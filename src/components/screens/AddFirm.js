     ...
     <div className="" style={{padding:"20px",backgroundColor:"white",marginTop:70}}>
        ...
        <div className='flex flex-row form-group' style={{justifyContent:'space-between',marginTop:20,marginRight:'20%'}}>
         ...
         <label className="" style={{}}>Firm Name</label>
            ...
            <input type="text" onChange={(text) => setLawyerName(text.target.value)} name="lawyername" className="form-control" placeholder="Firm Name" style={{width:'60%'}}required/>
        </div>
          
        <div className='flex flex-row' style={{justifyContent:'space-between',marginTop:20,marginRight:'20%'}}>
        <label style={{}}>Email</label>
        <input type="email" onChange={(text) => setLawyerEmail(text.target.value)} name="email"  className="form-control" placeholder="Firm email" style={{width:'60%'}} required />
        </div> 

               <div className='flex flex-row' style={{justifyContent:'space-between',marginTop:20,marginRight:'20%'}}>
                <label style={{}}>Address </label>
                <input type="text" onChange={(text) => setLawyerAddress(text.target.value)} name="address"  className="form-control" placeholder="Firm address" style={{width:'60%'}} required />
               </div>
                ...
                <input type="text" onChange={(text) => setLawyerPhone(text.target.value)} name="phonenumber" className="form-control" placeholder="Phone number" style={{width:'60%'}} required />
                </div>
